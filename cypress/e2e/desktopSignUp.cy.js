describe('Galuma Create Account Tests for Desktop', () => {
  ...
  it('TC_PRIVACY_POLICY_LINK_014 - Validate that clicking the Privacy Policy link in the New Account popup redirects to the correct Privacy Policy page.', () => {
    // Login link is already clicked in beforeEach
    // Verify we're on the login page
    cy.get('#customer-email').should('be.visible')
  ...
  it('TC_TERMS_CONDITIONS_LINK_015 - Confirm that clicking the Terms and Conditions link in the New Account popup redirects to the correct Terms and Conditions page.', () => {
    // Login link is already clicked in beforeEach
    // Verify we're on the login page
    cy.get('#customer-email').should('be.visible')
