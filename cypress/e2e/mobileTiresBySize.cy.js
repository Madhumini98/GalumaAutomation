describe('Galuma Mobile Tires By Size Page Tests', () => {
    ...
    it('TC_GALUMA_MOBILE_TBS_PAGINATION_019 - Verify user can navigate pages using left and right arrow buttons', () => {
        // Navigate to shop tires by size page
        cy.visit("https://dev.galumatires.com/t/s", {
            auth: {
                username: 'galumadev',
                password: 'Test.123'
    ...
    it('TC_GALUMA_MOBILE_TBS_CART_020 - Verify user can able to add the product in cart and remove the product from my cart', () => {
