describe('Galuma Desktop Search Icon Functionality Tests', () => {
    ...
    it('TC_GALUMA_SEARCHHEADER_002 - Verify user can search for products and navigate to specific product', () => {
        ...
        cy.get('#searchbar-input').first().should('be.visible').type('Pirelli')

        // Wait for search suggestions to load
        cy.wait(2000)

        // Click on the specific Pirelli product from search suggestions
        cy.get('[href="https://dev.galumatires.com/p/2x-tires-likenew-pirelli-p-zero-pz4-315-30-21-315-30r21-3153021-105y-64677"]').should('be.visible').click()
    ...
    it('TC_GALUMA_SEARCHBUTTON_003 - Verify user can search for product by size', () => {
        ...
        cy.get('.special > .thick-form > .active > .popup-dimentions-home > :nth-child(1) > .form-group > .form-control-popup > #tire-width-value-read-tires').should('be.visible').click()
        ...
        cy.get('.special > .thick-form > .active > .popup-dimentions-home > :nth-child(2) > .form-group > .form-control-popup > #tire-ratio-value-read-tires').should('be.visible').click()
        ...
        cy.get('.special > .thick-form > .active > .popup-dimentions-home > :nth-child(3) > .form-group > .form-control-popup > #tire-diameter-value-read-tires').should('be.visible').click()
    ...
    it('TC_GALUMA_SEARCHBUTTON_004 - Verify form field dependencies when changing width clears subsequent fields', () => {
        // Navigate to Search button
        cy.get('.sec_side_icon > #open-search-popup').should('be.visible').click()
    ...
    it('TC_GALUMA_SEARCHBUTTON_005 - Verify error message displays when user attempts to search without selecting aspect ratio', () => {
        // Navigate to Search button
        cy.get('.sec_side_icon > #open-search-popup').should('be.visible').click()
    ...
    it('TC_GALUMA_SEARCHBUTTON_006 - Verify user can search for products by selecting brand and model', () => {
        // Navigate to Search button
        cy.get('.sec_side_icon > #open-search-popup').should('be.visible').click()
    ...
    it('TC_GALUMA_SEARCHBUTTON_007 - Verify model selection clears when brand changes and user can search with new brand-model combination', () => {
        // Navigate to Search button
        cy.get('.sec_side_icon > #open-search-popup').should('be.visible').click()
